  ...
  case "${BUILDKITE_PLUGIN_DOCKER_CACHE_STRATEGY:-hybrid}" in
    ...
    "hybrid"|*)
      ...
      if image_exists_in_registry "$cache_image"; then
        ...
        fallback_cache_image=$(build_cache_image_name | sed "s/:cache-.*/:${BUILDKITE_PLUGIN_DOCKER_CACHE_FALLBACK_TAG}/")
...
save_gar_cache() {
  ...
  local latest_image
  latest_image=$(build_cache_image_name | sed "s/:cache-.*/:${BUILDKITE_PLUGIN_DOCKER_CACHE_FALLBACK_TAG}/")
